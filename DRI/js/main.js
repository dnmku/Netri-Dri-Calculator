...
function changeNote(probability) {
    ...
    document.getElementById("noteLi").insertAdjacentHTML("beforeend", "<p>Note: DRI as per <span>" + val[0] + "± 0.5</span> pixels for Detection<span>" + val[1] + " ± 1.5</span> pixels for recognition and<span>" + val[2] + "± 2</span> for Identification with<span> " + probability + "%</span> probability of achieving the objective, at the specified distance.</p>");
}
